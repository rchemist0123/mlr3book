...
Parallelization refers to the process of running multiple jobs simultaneously in order to 
...
This sub-chapter provides guidance on how and when to use parallelization in mlr3.
...
The section provides an illustration of how to implement [Database Backends](#backends) using the NYC flight dataset.
